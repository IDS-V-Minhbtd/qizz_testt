...
<div class="container py-5">
    ...
    <form action="{{ route('admin.quizzes.questions.create', $quiz->id) }}" method="POST">
        @csrf
        <div class="mb-3">
...
<script>
    document.getElementById('answer_type').addEventListener('change', function () {
        ...
        console.log('Answer type changed to:', type);  // Debug: log the selected answer type
        ...
        document.getElementById('true-false-answers').style.display = 'none';

        // Show the correct answer options based on the selected type
