            ...
            <div class="mb-3">
                ...
                <div id="answers-container">
                    <div class="input-group mb-3">
                        <input type="text" name="answers[]" class="form-control" placeholder="Đáp án 1" value="{{ old('answers.0') }}">
                        <div class="input-group-text">
                            <input type="radio" name="correct_answer" value="0" {{ old('correct_answer') == '0' ? 'checked' : '' }} required>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="answers[]" class="form-control" placeholder="Đáp án 2" value="{{ old('answers.1') }}">
                        <div class="input-group-text">
                            <input type="radio" name="correct_answer" value="1" {{ old('correct_answer') == '1' ? 'checked' : '' }} required>
                        </div>
                    </div>
                </div>
...
<script>
    (function() {
        ...
        function toggleAnswerSections() {
            ...
            console.log('Answer type changed to:', type);
        ...
        document.getElementById('add-answer').addEventListener('click', function () {
            ...
            const answerInputs = container.getElementsByTagName('input').length / 2; // Chia 2 vì có input text và radio
            if (answerInputs >= 10) {
            ...
            newAnswerInput.innerHTML = `
                <input type="text" name="answers[]" class="form-control" placeholder="Đáp án mới">
                <div class="input-group-text">
                    <input type="radio" name="correct_answer" value="${answerInputs}" required>
                </div>
            `;
